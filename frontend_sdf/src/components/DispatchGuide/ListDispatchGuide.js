...
import { getAllDispatchGuides, showDispatchGuide } from "../../services/apiDispatchGuide";
import ModalDispatchGuide from "./ModalDispatchGuide";
...
function ListDispatchGuide() {
  ...
  const redirectToCreate = () => {
    window.location.href = "/dispatch-guide/create";
  };
  ...
  // ----------------------
  useEffect(() => {
    const table = $("#ListDispatchGuideDt").DataTable();
        ...
        <div className="w-full lg:w-12/12">
          <div className="relative bg-white flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="rounded-t bg-white mb-0 px-6 py-6 flex justify-between items-center border-b">
              <h6 className="text-blueGray-700 text-xl font-bold">Lista de Guías de Despacho</h6>
...
export default ListDispatchGuide;
