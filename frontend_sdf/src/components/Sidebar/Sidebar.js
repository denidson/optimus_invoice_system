  ...
  const menuSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { to: "/endClients", icon: "fas fa-users", label: "Clientes", roles: ["operador_admin", "operador", "visor", "auditor"] },
        { to: "/products", icon: "fas fa-cubes", label: "Producto/Servicio", roles: ["admin", "operador_admin", "operador", "visor", "auditor"] },
        { to: "/taxpayer", icon: "fas fa-tags", label: "Tipos de Contribuyentes", roles: ["admin", "operador_admin", "visor", "auditor"] },
        { to: "/taxes", icon: "fas fa-percent", label: "Impuestos", roles: ["admin", "operador_admin", "visor", "auditor"] },
        { to: "/config-withholdings", icon: "fas fa-percent", label: "Retenciones", roles: ["admin", "operador_admin", "visor", "auditor"] },
