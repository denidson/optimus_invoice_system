            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg bg-blueGray-100 border-0">
              <div class="rounded-t bg-white mb-0 px-6 py-6">
                ...
                <div class="px-5 text-center flex justify-between">
                  ...
                  <div className="lg:w-6/12 text-start">
                    {/*<label class="text-blueGray-700 lg:w-6/12 font-bold me-3">Total:</label>
                    <label class="text-blueGray-700 lg:w-8/12">{message.total}</label>*/}
                  </div>
                </div>
                <hr class="mx-3 my-6 border-b-1 border-blueGray-300"/>
                <div class="px-5 text-center flex justify-between border-4 p-2 border-double mb-4"> {/*border-b-4*/}
                  ...
                  {message.items && message.items.length > 0 ? (
                    message.items.map((item) => (
                      <div key={item.id} class="px-5 text-center flex justify-between border-b p-2 border-solid">
                        <div className="lg:w-4/12 text-start">
                          <label className="text-blueGray-700">{item.producto_id}</label>
                        </div>
                        <div className="lg:w-4/12 text-center">
